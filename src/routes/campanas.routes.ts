...
router.post('/batch-inversiones-costo', campanasController.getBatchInversionesCostoPorCatorcena.bind(campanasController));
router.get('/batch-inventarios', campanasController.getBatchInventarios.bind(campanasController));
...
router.post('/:id/completar-correccion', campanasController.completarCorreccionEnviarRevision.bind(campanasController));
