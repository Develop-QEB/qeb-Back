    ...
    try {
      ...
      const cliente = await prisma.cliente.create({
        data: {
          ...
          T1_U_ValidFrom: clienteData.T1_U_ValidFrom,
          T1_U_ValidTo: clienteData.T1_U_ValidTo,
          ...
          T2_U_ValidFrom: clienteData.T2_U_ValidFrom,
          T2_U_ValidTo: clienteData.T2_U_ValidTo,
        },
      });
